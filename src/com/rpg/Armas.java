...
public class Armas{
    ...
    * 6 = besta <3 flecha>
    * 7 = granada <granada>
    * 8 = lan√ßa granadas <all granadas [dano = numero de granadas * dano da granada]>
...
public boolean temMunicao(){
    ...
    public void setBala(int municao) {
        ...
        System.out.println("VocÍ recebeu "+municao+" balas");
    ...
    public void setGranada(int municao) {
        ...
        ferramentas.linhas(50);
        System.out.println("VocÍ recebeu "+municao+" granadas");
    ...
    public void setFlecha(int municao) {
        ...
        ferramentas.linhas(50);
        System.out.println("VocÍ recebeu "+municao+" flechas");
    ...
    public void setMana(int municao) {
        ...
        ferramentas.linhas(50);
        System.out.println("VocÍ recebeu "+municao+" de mana");
